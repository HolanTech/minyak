...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        <div class="left">
            ...
            <div class="pagetitle">Edit Produk</div>
            <div class="right"></div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form action="/produk.{{ $produk->id }}.update" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $produk->satuan }}" class="form-control" name="satuan"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $produk->beli }}" class="form-control" name="beli"
        ...
        <div class="row">
            ...
            <div class="col-11">
                <input type="text" value="{{ $produk->jual }}" class="form-control" name="jual"
        ...
        <div class="row">
            ...
            <div class="col-11">
                ...
                <input type="hidden" value="{{ $produk->foto }}" class="form-control" name="old_foto">
                {{-- <input type="hidden" value="{{ $produk->password }}" class="form-control" name="password"> --}}
