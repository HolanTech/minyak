...
<body class="bg-white">
    <style>
        #appCapsule {
            ...
            background-color: rgb(248, 244, 16);
            height: 680px;
            background-position: right;
            /* Menyeting gambar latar belakang dari sebelah kanan */
        }

        .section h2 {
            text-shadow: 2px 2px blanchedalmond;
            /* Misalnya, menggunakan bayangan horizontal 2px dan bayangan vertikal 2px */
            color: rgb(0, 0, 0);
        }
